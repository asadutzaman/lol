...
<body>
    ...
    <div class="row-fluid">
            ...
            <!--COMPLAIN TAKING FORM AREA-->
                          <form action="agent/create_ticket.php" method="POST" name="ticket">
                          			<div class="span12" align="center">
                                        	<input type="tel" name="customer_no" placeholder="Customer Number" required>
                                        </div>
...
<option></option>
                                                    ...
                                                    <div class="span6">
                                                      <table>
                                                          <tr>
                                                              ...
                                                              <td><input name="3g1_division" type="text"  ></td>
                                                          </tr>

                                                          <tr>
                                                              <td><label>DISTRICT:</label></td>
                                                              <td><input name="3g1_district"   type="text"  ></td>
                                                          </tr>
                                               ...
                                               <div class="form-inline">
                                                <div class="span6">
                                                    <table>
                                                      <tr>
                                                        <td><label>DIVISION</label></td>
                                                        <td><input name="3g2_division" type="text" ></td>
                                                      </tr>
                                                      <tr>
                                                        <td><label>DISTRICT:</label></td>
                                                        <td><input name="3g2_district" type="text"  ></td>
                                                      </tr>
                                                       <tr >
                                                        <td><label>THANA:</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div  class="span6">
                                                       <table>
                                                            <tr>
                                                              <td><label>Division</label></td>
                                                              <td><input name="net1_division" type="text"  ></td>
                                                            </tr>
                                                            <tr>
                                                              <td><label>District</label></td>
                                                              <td><input name="net1_district" type="text" ></td>
                                                            </tr>
                                                             <tr>
                                                              <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                         <table>
                                                            <tr>
                                                              <td><label>Division</label></td>
                                                              <td><input name="net2_division" type="text"  ></td>
                                                            </tr>
                                                            <tr>
                                                              <td><label>District</label></td>
                                                              <td><input name="net2_district" type="text" ></td>
                                                            </tr>
                                                             <tr>
                                                              <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                          <table>
                                                            <tr>
                                                              <td><label>Division</label></td>
                                                              <td><input name="net3_division" type="text"  ></td>
                                                            </tr>
                                                            <tr>
                                                              <td><label>District</label></td>
                                                              <td><input name="net3_district" type="text" ></td>
                                                            </tr>
                                                             <tr>
                                                              <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                          <table>
                                                              <tr>
                                                                <td><label>Division</label></td>
                                                                <td><input name="net4_division" type="text"  ></td>
                                                              </tr>
                                                              <tr>
                                                                <td><label>District</label></td>
                                                                <td><input name="net4_district" type="text" ></td>
                                                              </tr>
                                                               <tr>
                                                                <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      ...
                                                      <div class="span6">
                                                         <table>
                                                          <tr>
                                                            <td><label>Division</label></td>
                                                            <td><input name="net5_division" type="text"  ></td>
                                                          </tr>
                                                          <tr>
                                                            <td><label>District</label></td>
                                                            <td><input name="net5_district" type="text" ></td>
                                                          </tr>
                                                           <tr>
                                                            <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                        <table>
                                                          <tr>
                                                            <td><label>Division</label></td>
                                                            <td><input name="net6_division" type="text"  ></td>
                                                          </tr>
                                                          <tr>
                                                            <td><label>District</label></td>
                                                            <td><input name="net6_district" type="text" ></td>
                                                          </tr>
                                                           <tr>
                                                            <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                        <table>
                                                          <tr>
                                                            <td><label>Division</label></td>
                                                            <td><input name="net7_division" type="text"  ></td>
                                                          </tr>
                                                          <tr>
                                                            <td><label>District</label></td>
                                                            <td><input name="net7_district" type="text" ></td>
                                                          </tr>
                                                           <tr>
                                                            <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                        <table>
                                                            <tr>
                                                              <td><label>Division</label></td>
                                                              <td><input name="net8_division" type="text"  ></td>
                                                            </tr>
                                                            <tr>
                                                              <td><label>District</label></td>
                                                              <td><input name="net8_district" type="text" ></td>
                                                            </tr>
                                                             <tr>
                                                              <td><label>Thana</label></td>
                                                      ...
                                                      <div class="form-inline">
                                                        <div class="span6">
                                                          <table>     
                                                              <tr>
                                                                <td><label>Division</label></td>
                                                                <td><input name="net9_division" type="text"  ></td>
                                                              </tr>
                                                              <tr>
                                                                <td><label>District</label></td>
                                                                <td><input name="net9_district" type="text" ></td>
                                                              </tr>
                                                               <tr>
                                                                <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                        <table>     
                                                              <tr>
                                                                <td><label>Division</label></td>
                                                                <td><input name="ser1_division" type="text"  ></td>
                                                              </tr>
                                                              <tr>
                                                                <td><label>District</label></td>
                                                               <td> <input name="ser1_district" type="text"  ></td>
                                                              </tr>
                                                               <tr >
                                                                <td><label>Thana</label></td>
                                                    ...
                                                    <div class="form-inline">
                                                      <div class="span6">
                                                         <table>
                                                            <tr>
                                                              <td><label>Division</label></td>
                                                              <td><input name="ser2_division" type="text"  ></td>
                                                            </tr>
                                                            <tr>
                                                              <td><label>District</label></td>
                                                              <td><input name="ser2_district" type="text"  ></td>
                                                            </tr>
                                                             <tr >
                                                              <td><label>Thana</label></td>
                                                     ...
                                                     <div class="form-inline">
                                                        <table>
                                                          ...
                                                          <tr>
                                                           ...
                                                           <tr>
                                                            <td><label>Alternate No:</label></td>
                                                            <td><input name="ser3_alt_name" type="text"></td>
                                                          </tr>
                                                        </table>  
                                                    </div>
                                                 </div>  
                                    ...
                                    <input type="checkbox" value="2" name="status"> Check, if issue solved.
                                    <button style="margin-top:5px;" class="btn btn-xs btn-success">SEND</button></div>
                          </form>
