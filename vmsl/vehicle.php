...
<!--                     <li><a rel="nofollow" href="message.html" class="dropdown-item d-flex"> 
                ...
                <div class="col-lg-9">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4"><i class="fa fa-registered"></i>Vehicle Registration</h3>
                    </div>
                    <div class="card-body">
                      <p>Please insert driver information</p> 
                       <form action="insertvehicle.php" method="post" enctype="multipart/form-data">';
                        ...
                        $mydate=date("Ym");
                        $mydate="DG".$mydate. date("His");
                       // echo $mydate;
                        
                    echo'<div class="form-group">
                          <label class="form-control-label">Car ID</label>
                          <input type="text" name="car_id"  id="car_id"  value="'; echo $mydate; echo'" placeholder="Enter Car Id" class="form-control" readonly >
                        </div>

                        <div class="form-group">
                          <label class="form-control-label">license No</label>
                          <input type="text" name="license" id="license" placeholder="Enter license no" class="form-control">
                        </div>

                        <div class="form-group">
                          <label class="form-control-label">vehicle paper</label>
                        ...
                        <div class="form-group">       
                          ...
                          <input type="text" name="vendor" id="vendor" placeholder="Enter vendor name" class="form-control">
                        </div>

                        <div class="form-group">       
                          <label class="form-control-label">Seat Capacity</label>
                          <div>
                            <input type="number" name="mynumber"  id="mynumber" placeholder="Enter seat capacity"  class="form-control">
                          </div>
                        </div>

                        <div class="form-group">       
                          <label class="form-control-label">Remarks</label>
                          <textarea class="form-control rounded-0"  name="remarks" id="remarks" rows="3"></textarea>
                        </div>
    ...
    <script src="js/front.js"></script>
     <script src="js-customize/vehicle.js" type="text/javascript"></script>
  </body>
</html>
<style type="text/css">
  #vehicle_section{
