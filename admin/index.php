...
if(isset($_POST['btn-login'])){
	...
	if($login->do_login($uname,$umail,$upass)){
	    $login->redirect('home.php');
	}
	else
	{
...
<html>
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>-:Transport:-</b>System</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Sign in</br><?php //echo $login_error_message; ?></p> 
            <div id="error">
                <?php
			        if(isset($error)){
			    ?>
            ...
            <form action="" method="post">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="txt_uname_email" placeholder="NTID" >
